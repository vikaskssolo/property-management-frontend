...
function VendorNavbar(props) {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <Link to="/vendor/dashboard" className="flex items-center outline-none">
          Dashboard
        </Link>
      </Typography>
      {/* <Typography
      ...
      <Typography
        ...
        onClick={() => {
          localStorage.removeItem("property_vendor_access_token");
          navigate("/");
        }}
      >
        Logout
