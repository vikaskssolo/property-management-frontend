...
function UserNavbar(props) {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <Link to="/user/dashboard" className="flex items-center outline-none">
          Dashboard
        </Link>
      </Typography>
      <Typography
      ...
      <Typography
        ...
        className="p-1 font-normal"
      >
        <Link to="/user/wishlist" className="flex items-center outline-none">
          Wishlist
        </Link>
      </Typography>
      <Typography
        ...
        className="p-1 font-normal"
      >
        <Link to="/user/my_bookings" className="flex items-center outline-none">
          My Bookings
        </Link>
      </Typography>
      {access_token ? (
